...
export function validateAndSanitizeSettings(input: unknown): OverlaySettings {
  ...
  const completeSettings: OverlaySettings = {
    ...
    distanceStyle: (cleanSettings.distanceStyle === 'default' || cleanSettings.distanceStyle === 'compact' || cleanSettings.distanceStyle === 'cyberpunk' || cleanSettings.distanceStyle === 'minimal-bar' || cleanSettings.distanceStyle === 'no-background' || cleanSettings.distanceStyle === 'borderless') ? cleanSettings.distanceStyle : DEFAULT_OVERLAY_SETTINGS.distanceStyle,
